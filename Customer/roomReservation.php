...
$ID = $_SESSION['ID'];
    $sql11 = "SELECT * from replay_msg where customer_ID = '$ID'";
    $result11 = mysqli_query($db,$sql11);
    $num11 = mysqli_num_rows($result11);
$first = "SELECT * from check_in where customer_ID = '$ID'";
$f_result = mysqli_query($db,$first);
$f_num = mysqli_num_rows($f_result);
?>
...
<header class="topmenu">
        <nav>
            <ul>
                <li class="topitem" style="padding-right: 20px;"><a href="messages.php"><i class="fa-solid fa-comment"></i><span class="badge" style="background-color:darkred;color:white"><?php echo $num11; ?></span></a></li>
            ...
            <a href="home.php" class="mylogo">lucy hotel<span>cradle of lexury</span></a>
                <ul class="mymenu">
                    ...
                    <li class="mymenu-current drop"><a href="roomReservation.php" class="mymenu-link"><i class="fa-solid fa-file-circle-check"></i>Reservation <i class="fa-solid fa-caret-down" id="last"></i></a>
                        <ul class="mydropdown">
                            <li class="dropitem current"><a href="roomReservation.php" class="mymenu-link"><i class="fa-solid fa-caret-right"></i>Room Reservation</a></li>
    ...
    <section id="body">
        <div class="container">
            <div class="row"><!-- row -->
                <div class="col-md-3 side"><!-- colomn 1 -->
                    <ul>
            ...
            // to know the name of the persone email and phone number
                    ...
                    $room_sql = "SELECT * from room_reservation where customer_ID = '$ID'";
                    ...
                    <div class="row"><!--row1-->
                        ...
                        <div class="col-md-6">
                            <div>
                                ...
                                <form action="uploadTransaction.php" method="post" enctype="multipart/form-data">
                                    <input type="file" name="transaction" class="button"><br>
                ...
                <div class="col-md-8"><!--colomn2-->
                    <h4>Room Reservation</h4>
                    <p>There is no room reserved</p>
                    <a href="http://localhost/lucy hotel/Customer/newReservation.php"><button class="button">Reserve now</button></a>
                </div>
                ...
                <div class="col-md-8"><!--colomn2-->
                    <h4>Room Reservation</h4>
                    <p>you already checkin to the hotel you can order meal online using this system</p>
