                ...
                <div class="col-md-9">
                    ...
                    <div><!-- table -->
                        <table class="table">
                            ...
                            $sql = "SELECT * from hall_reservation ORDER BY hall_reservation.ID DESC";
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                <tr>
                                    ...
                                    <form action="hallcheck.php" method="post">
                                    ...
                                    <form action="hallacceptReservation.php" method="POST">
                                        <input type="text" name="reserv_id" value="<?php echo $row['ID']; ?>" hidden>
                                        <?php
                                    ...
                                    <form action="halldeletereservation.php" method="POST">
                                        <input type="text" name="reserv_id" value="<?php echo $row['ID']; ?>" hidden>
                                        <?php
