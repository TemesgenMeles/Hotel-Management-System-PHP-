            ...
            <div class="row"><!-- row -->
                ...
                <div class="col-md-9">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td><?php echo $num; ?></td>
                            <td><?php echo $row_system['first_name']; ?></td>
                            <td><?php echo $row_system['last_name']; ?></td>
                            <td><?php echo $row_system['email']; ?></td>
                            <td><?php echo $row_system['phone_number']; ?></td>
                            <form action="viewCustomer.php" method="POST">
                                <input type="text" name="reser" value="<?php echo 'system'; ?>" hidden>
                                <input type="text" name="id" value="<?php echo $row_system['customer_ID']; ?>" hidden>
