            ...
            <div class="row"><!-- row -->
                ...
                <div class="col-md-9">
                    <div class="row">
                        <div class="col-md-10">
                            <h4>CheckIn</h4>
                            <p>Customers Which Checkin to The Hotel</p>
                        </div>
                        <div class="col-md-2">
                    ...
                    <table class="table">
                        ...
                        <?php
                        $num = 0;
                            while ($row_checkin = mysqli_fetch_array($result_checkin)) {
                                $num++;
                                $id = $row_checkin['customer_ID'];
                        ...
                        <tr>
                            ...
                            <form action="viewCustomer.php" method="POST">
                                <input type="text" name="reser" value="<?php echo 'checkin'; ?>" hidden>
